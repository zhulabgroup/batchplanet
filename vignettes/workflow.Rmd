...
```{r, eval = F}
read_tree_inventory_all(v_site = c("NY", "SJ", "HT", "DT", "DV", "ST", "AT", "TP"))
```
...
```{r}
df_evi <- read_evi(dir = "alldata/PSdata/evi/", v_site = "NY", v_taxa = "Acer")
vis_ts(df_evi, v_site = "NY", v_taxa = "Acer", v_id = NULL, n_id = 5, v_year = 2017:2022, smooth = T)
```
...
```{r}
df_doy <- read_doy(dir = "alldata/PSdata/doy/", v_site = "NY", v_taxa = "Acer")
df_doy
vis_doy(df_evi, df_doy, v_site = "NY", v_taxa = "Acer", v_id = NULL, n_id = 5, v_year = 2017:2022, smooth = T)
```
