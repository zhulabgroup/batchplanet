...
```{r}
df_evi <- read_evi(dir = "alldata/PSdata/", v_site = "AT")
vis_evi(df_evi, v_site = "AT", v_id = 1:5, v_year = 2017:2022)
```

## Get day of year for green-up and green-down
```{r}
proc_doy(dir = "alldata/PSdata/", v_site = cityoi, v_year = NULL, v_id = NULL, df_thres = NULL, min_days = 50)
```
