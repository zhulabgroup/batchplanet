...
```{r}
df_evi <- read_evi(dir = "alldata/PSdata/evi/", v_site = cityoi, v_taxa = "Quercus")
vis_ts(df_evi, v_site = cityoi, v_taxa = "Quercus", v_id = NULL, n_id = 5, v_year = 2017:2022, smooth = T)
```
