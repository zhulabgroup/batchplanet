...
```{r}
df_ts_example <- read_data_product(dir = file.path(dir_data, "NEON"), v_site = "SJER", v_group = "Quercus", product_type = "ts")
...
```{r}
df_clean_example <- read_data_product(dir = file.path(dir_data, "NEON"), v_site = "SJER", v_group = "Quercus", product_type = "clean")
