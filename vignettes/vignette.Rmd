...
Make sure your data have the columns: `id` (unique id for each point of interest), `lon`, `lat`. You may have the columns `site` if you have concentrated coordinates at dispersed sites, like in our example. You may also have other columns the you can use to group coordinates later on. 
