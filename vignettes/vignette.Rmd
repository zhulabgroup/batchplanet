...
```{r, eval = F}
order_planetscope_imagery_batch(dir = file.path(dir_data, "urban"), df_coordinates = df_coordinates_urban, v_site = c("ST", "AT"), v_year = 2025, v_month = 5, setting = setting)
```
...
```{r, eval = F}
download_planetscope_imagery_batch(dir = file.path(dir_data, "urban"), v_site = c("ST", "AT"), v_year = 2025, v_month = 5, setting = setting, num_cores = 3, overwrite = F)
```
