...
If you would like to customize your time series retrieval process, you may use the function `retrieve_planetscope_time_series()`.
```{r, eval = F}
df_coordinates_example <- df_coordinates %>% filter(site == "SJER")
