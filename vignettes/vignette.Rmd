...
```{r}
df_ts_example <- read_rds(system.file("extdata", "ts/ts_SJER_Quercus.rds", package = "batchplanet"))
...
```{r}
df_clean_example <- read_rds(system.file("extdata", "clean/clean_SJER_Quercus.rds", package = "batchplanet"))
df_thres <- set_thresholds(thres_up = c(0.3, 0.4, 0.5), thres_down = NULL)
